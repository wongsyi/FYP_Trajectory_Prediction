...
class RNN_CGNN_2E_Att_64(pl.LightningModule):
    def __init__(self, args):
        super(RNN_CGNN_2E_Att_64, self).__init__()
        self.args = args
    ...
    def init_args(parent_parser):
        ...
        parser_model.add_argument("--latent_size", type=int, default=64) #hidden size
