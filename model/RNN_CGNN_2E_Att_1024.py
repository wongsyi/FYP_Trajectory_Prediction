...
class RNN_CGNN_2E_Att_1024(pl.LightningModule):
    def __init__(self, args):
        super(RNN_CGNN_2E_Att_1024, self).__init__()
        self.args = args
    ...
    def init_args(parent_parser):
        ...
        parser_model.add_argument("--latent_size", type=int, default=1024) #hidden size
