...
class RNN_CGNN_2E_Att_Skipped(pl.LightningModule):
    def __init__(self, args):
        super(RNN_CGNN_2E_Att_Skipped, self).__init__()
        self.args = args
    ...
    def forward(self, batch):
        ...
        out_self_attention_filtered = out_self_attention[main_vehicle_index]

        ### Decoder ###
        out_linear = self.decoder_residual(out_self_attention_filtered, self.is_frozen)
