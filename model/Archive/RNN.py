...
class RNN(pl.LightningModule):
    def __init__(self, args):
        ...
        self.encoder_rnn = EncoderRNN(self.args)
    ...
    def forward(self, batch):
        ...
        # Decoder Layer
        ###################################################################################
        out_linear = self.decoder_residual(out_encoder_rnn, self.is_frozen)
...
class EncoderRNN(nn.Module):
    ...
    def forward(self, rnn_in, agents_per_sample):
        ...
        # rnn_out is the hidden state over all time steps from the last LSTM layer
