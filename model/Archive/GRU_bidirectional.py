...
class EncoderGRU(nn.Module):
    def __init__(self, args):
        ...
        self.hidden_size = int((args.latent_size)/2)
    ...
    def forward(self, rnn_in, agents_per_sample):
        ...
        # rnn_hidden_state = torch.randn(2 * self.num_layers, rnn_in.shape[0], self.hidden_size, device=rnn_in.device)

        rnn_out, rnn_hidden = self.GRU(rnn_in)
